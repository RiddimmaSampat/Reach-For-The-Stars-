...
spawnStars();
  ...
  if(touches.length>0 || mousePressedOver(restart)) {
    ...
    wins=createSprite(displayWidth/2,displayHeight/2+15);
...
textSize(17)  
  text('Points:'+score,displayWidth/2-40, displayHeight-660)
  text('Press Space, or tap the screen to keep levitating!', displayWidth/2-180, displayHeight-640)
}
